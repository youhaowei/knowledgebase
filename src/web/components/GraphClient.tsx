...
export function GraphClient({ nodes, links, onNodeClick, selectedNodeName }: GraphClientProps) {
  ...
  return <Graph nodes={nodes} links={links} onNodeClick={onNodeClick} selectedNodeName={selectedNodeName} />;
}
